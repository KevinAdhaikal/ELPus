                  ...
                  <tr id="{{ $book->id }}">
                    ...
                    <td>
                      ...
                      <center>
                        ...
                        <button type="button" class="text-right btn btn-success action_borrow" value="{{ $book->id }}"><i class="fas fa-hand-holding"></i> Pinjam Buku</button>
                      </center>
                      @else
                      <center>
                        <button type="button" class="text-right btn btn-primary action_view"><i class="fa fa-eye" disabled></i> Lihat</button>
                        <button type="button" class="text-right btn btn-success action_borrow"><i class="fas fa-hand-holding" disabled></i> Pinjam Buku</button>
                      </center>
                      @endif
                    </td>
                  </tr>
